...
<body>
  ...
  <nav class="navbar">
    ...
    <div style="margin-top: 100px;" class="container">
        ...
        <div class="col-md-12">
            <div class="col-md-3"> <img src="{{asset('img/'.$book->image.'')}}" class="img-responsive"></div>
            <div class="col-md-9"><h1 style="font-weight: 100; margin-top: 10%;">{{$book->compName}}</h1></div>
        </div>
        ...
        <div class="col-md-9 pull-right">
            ...
            <h2>Contact</h2>
            <p>Contactpersoon: {{$book->author}}</p>
            <p>Email: {{$book->publisher}}</p>
